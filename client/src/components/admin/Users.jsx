    ...
    const deleteUserHanler = async (e, userId) => {
        ...
        try {
            ...
            if (deletedUser.status === 200) {
                ...
                dispatch(openModal({ heading: "Delete", body: "User is been deleted successfully" }));
            } else if (deletedUser.status === 405) {
                dispatch(openModal({ heading: "Can not delete", body: "You do not have the previllage to delete" }));
            }
        } catch (error) {
            console.log(error);
        }
